...
/*********************************************************************
 * FUNCTION NAME: BubbeSort1
 * PURPOSE: Sorts a list using bubble sort 1 algorithm.
...
/*********************************************************************
 * FUNCTION NAME: BubbeSort2
 * PURPOSE: Sorts a list using bubble sort 2 algorithm.
 * ARGUMENTS: The address of the List variable to be initialized 
 ********************************************************************/
extern void BubbleSort2 (List * A);


/*********************************************************************
 * FUNCTION NAME: MergeSort
 * PURPOSE: Sorts a list using merge sort algorithm.
 * ARGUMENTS: The address of the List variable to be initialized, the position of the first and last elements 
 ********************************************************************/
extern void MergeSort (List * A, int first, int last);


/*********************************************************************
 * FUNCTION NAME: Merge
 * PURPOSE: Called by the MergeSort algorithm.
 * ARGUMENTS: The address of the List variable to be initialized, the position of the first, middle, and last elements. 
 ********************************************************************/
extern void Merge (List * A, int first, int middle, int last);
